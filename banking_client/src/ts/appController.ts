...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      ...
      {
        path: "dashboard",
        detail: { label: "Customers", iconClass: "oj-ux-ico-bar-chart" },
      },
      {
        path: "incidents",
        detail: { label: "Login", iconClass: "oj-ux-ico-fire" },
      },
      {
        path: "customers",
        detail: { label: "Registration", iconClass: "oj-ux-ico-contact-group" },
      },
      {
        path: "about",
